...
namespace SingleBoostr.Core
{
    public class SteamApp
    {
        ...
        /// APP Title
        /// </summary>
        public string Title { get; private set; } = "Unknown game";
        ...
        /// </summary>
        public double Playtime { get; private set; } = 0;
        ...
        /// </summary>
        public bool Connect => Login();

        /// <summary>
        /// Logut user from steam and stop and idling
        /// </summary>
        public bool Disconnect => Logout();
        ...
        /// Validates API Key
        /// </summary>
        public bool APIkeyValid => !string.IsNullOrWhiteSpace(APIkey);

        /// <summary>
        /// API Wrapper
        /// </summary>
        public PlayerService? InterfacePlayerService { get; private set; }
        ...
        public SteamApp(uint appID, string apikey = "")
        {
            ID = appID;
            APIkey = apikey;
